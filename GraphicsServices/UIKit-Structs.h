...
typedef struct WKWindow {
	WKObject _field1;
	__unsafe_unretained WAKWindow* _field2;
	CGRect _field3;
	WKViewRef _field4;
	WKViewRef _field5;
...
typedef struct UIKeyToKeyIDCache {
	__unsafe_unretained NSString* previousKey[64];
...
typedef struct UIStringIDTableBucket {
	__unsafe_unretained NSString* _field1;
	unsigned _field2;
...
typedef struct {
	__unsafe_unretained UIImage* background;
	__unsafe_unretained UIImage* leftDivider;
	__unsafe_unretained UIImage* rightDivider;
	__unsafe_unretained UIColor* textColor;
	__unsafe_unretained UIColor* shadowColor;
	CGSize shadowOffset;
} XXStruct_KYn_rD, XXStruct_V3NSMA;

typedef struct {
	__unsafe_unretained UIFont* _field1;
	float _field2;
	float _field3;
